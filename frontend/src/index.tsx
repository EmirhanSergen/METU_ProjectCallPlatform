...
import CallApplicationsPage from "./pages/user/admin/CallApplicationsPage";
import CallDetailPage from "./pages/user/CallDetailPage";
import CallManagementPage from "./pages/user/admin/CallManagementPage";
import CallFormPage from "./pages/user/admin/CallFormPage";
import CallPage from "./pages/user/CallPage";
import DashboardPage from "./pages/user/admin/DashboardPage";
import HomePage from "./pages/system/HomePage";
import LoginPage from "./pages/auth/LoginPage";
import MyApplicationsPage from "./pages/user/applicant/MyApplicationsPage";
import NotFoundPage from "./pages/system/NotFoundPage";
import RegisterPage from "./pages/auth/RegisterPage";
import PasswordResetPage from "./pages/auth/PasswordResetPage";
import ReviewPage from "./pages/user/ReviewPage";
import ReviewerPage from "./pages/user/reviewer/ReviewerPage";
import SettingsPage from "./pages/system/SettingsPage";
import AdminUserManagementPage from "./pages/user/admin/AdminUserManagementPage";
import TermsPage from "./pages/system/TermsPage";
import PrivacyPage from "./pages/system/PrivacyPage";
import ApplicationLayout from "./pages/calls/ApplicationLayout";
import Step1_CallInfo from "./pages/calls/Step1_CallInfo";
import Step2_Upload from "./pages/calls/Step2_ApplicantInfo";
import Step3_Review from "./pages/calls/Step3_ApplicationDetails";
import Step4_Submit from "./pages/calls/Step4_DocumentsUpload";
import Step5_AcademicPortfolio from "./pages/calls/Step5_AcademicPortfolio";
import Step6_Mobility from "./pages/calls/Step6_Mobility";
import Step7_ProposalCV from "./pages/calls/Step7_ProposalCV";
import Step8_EthicsSecurity from "./pages/calls/Step8_EthicsSecurity";
import Step9_ReviewSubmit from "./pages/calls/Step9_ReviewSubmit";
